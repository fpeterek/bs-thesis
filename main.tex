...
Tato softwarová komponenta tedy zastává primárně roli klienta, to ovšem neznamená, že v roli klienta musí působit ve všech 
ohledech a aplikacích. Například pokud by došlo k implementaci monitorování pomocí technologie Prometheus, musel by software
vystavit své metriky pomocí HTTP serveru. Stejně tak by si využití HTTP serveru v této komponentě vyžádala i implementace webové 
aplikace pro zadávání pokynů vozidlu. V takové situaci s největší pravděpodobností dojde ke tvorbě jednoduchého REST API, 
se kterým bude webová aplikace komunikovat.
...
v okruhu okolo uživatelem zadaného bodu. Přesná navigace pomocí technologie GPS byla vyzkoušena a je popsána v podkapitole
...
jazyka Python jsou zde využity knihovny \emph{pygame}, \emph{geopy} a \emph{osmium}. 
...
Poslední využívaná knihovna, \emph{osmium}, slouží k parsování OpenStreetMap dat. Zpracování mapových podkladů se podrobněji
věnuje kapitola \nameref{osm-chapter}.
