...
nad vozidlem. V opačném případě je server považován za \emph{mrtvý}. 

Metoda \{healthcheck} ve své odpovědi posílá pouze jeden byte. Pokud je server živý, obsahuje odpověď nenulovou hodnotu. V opačném
