...
obce Kobeřice a přineslo výsledky v určitých ohledech překvapivé, v jiných zase předpokládatelné.

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Figures/louky.png}
    \caption{Rovná cesta středem ulice připomíná spíše večerní ploužení z nedalékého restauračního zařízení}
    \label{fig:louky}
\end{figure}
...
%TODO: Webová appka (už naprogramovaná, Kotlin+Ktor a JS+Mapy.cz, nějak popsat)
...
% https://stackoverflow.com/a/51127674 % Line line intersection in Python
% https://www.singletracks.com/mtb-gear/do-gps-units-always-overestimate-trail-distances-no/
