...
\Acknowledgement {
    Chtěl bych poděkovat vedoucímu mé práce, Janu Gaurovi, nejen za pomoc s tvorbou práce a návrhem softwaru,
...
\section{Řízení vozidla kombinací vstupů z GPS, kamery, a za využití mapových podkladů}
...
\subsection{Automatická aktualizace mapových podkladů}

\subsection{Cena cesty odvíjející se od denní doby}
