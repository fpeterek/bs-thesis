...
využití služby Mapy.cz souvisí především s jejím českým původem. Vývojáři Mapy.cz spolupracují přímo s českými úřady a často tak
dokážou zaznamenat změny v silniční síti rychleji než zahraniční nebo komunitní mapové služby. Drobnou roli hraje také vlastenecký
sentiment.
...
Mapové podklady jsou uloženy ve formátu XML, který využívá pro export projekt OpenStreetMap, nejsou převáděny do vlastního 
formátu. K načítání textového XML souboru je využita knihovna \emph{osmium}. Z tohoto souboru jsou přečteny uzly a cesty. Relace
jsou ignorovány. Při zpracování cest jsou uloženy pouze cesty povolených typů, ostatní typy cest jsou ignorovány. Mezi ignorované
typy patří např. \emph{footway}, \emph{corridor}, \emph{steps}. Podklady OSM často obsahují například chodníky či chodby, je ovšem
...
Při načítání jsou samozřejmě objekty modulu \emph{osmium} převedeny na instance vlastních tříd, definujících nové užitečné metody
či atributy.

\section{Vyhledání aktuální pozice na mapě}

%TODO: Tohle mám naprogramované, chci popsat (vyhledání nejbližšího bodu na nejbližším vektoru)
...
% https://pmj.bmj.com/content/97/1144/110
% https://www.csselectronics.com/screen/page/simple-intro-to-can-bus/language/en
%TODO: Nefunguje Bloomberg, ozdrojovat shitoměny
